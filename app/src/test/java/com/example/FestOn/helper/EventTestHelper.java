...
public class EventTestHelper {
    public static Event initEvent() {
        Address eventAddress = com.example.FestOn.helper.AddressTestHelper.initAddress1();
        ...
        event.setTicketCategories(com.example.FestOn.helper.TicketCategoryTestHelper.initArrayOfTicketCategories());
        event.setTicketDiscounts(com.example.FestOn.helper.TicketDiscountTestHelper.initArrayOfTicketDiscounts());
        return event;
    }
