...
public class TicketTestHelper {
    public static Ticket initTicket1(Event event) {
        TicketCategory ticketCategory = com.example.FestOn.helper.TicketCategoryTestHelper.initTicketCategory1();
        TicketDiscount ticketDiscount = com.example.FestOn.helper.TicketDiscountTestHelper.initTicketDiscount1();
        Ticket ticket = new Ticket(1, event, ticketCategory, ticketDiscount);
        return ticket;
    }

    public static Ticket initTicket2(Event event) {
        TicketCategory ticketCategory = com.example.FestOn.helper.TicketCategoryTestHelper.initTicketCategory2();
        TicketDiscount ticketDiscount = com.example.FestOn.helper.TicketDiscountTestHelper.initTicketDiscount2();
    ...
    public static Ticket initTicket3(Event event) {
        TicketCategory ticketCategory = com.example.FestOn.helper.TicketCategoryTestHelper.initTicketCategory3();
        TicketDiscount ticketDiscount = com.example.FestOn.helper.TicketDiscountTestHelper.initTicketDiscount2();
