package com.example.FestOn.view.Event.CreateEditEvent;

import static com.example.FestOn.util.Util.checkAddressFormat;
import static com.example.FestOn.util.Util.checkDateFormat;
import static com.example.FestOn.util.Util.checkTimeFormat;
